package com.acciojob.bookmyshowapplications.Config;

import com.acciojob.bookmyshowapplications.Filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers("/user/addUser", "/user/generateToken").permitAll()
                .and()
